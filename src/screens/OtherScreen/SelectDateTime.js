...
import { ic_activity, ic_calender, ic_coin, ic_location, ic_mobile, ic_user } from '../../constants/Images'
    ...
    return (
        <>
            <HeaderView HeaderSmall={true}
                title={Translate.t("select_date_time")} isBack={true} onPress={() => goBack()} containerStyle={{ paddingHorizontal: pixelSizeHorizontal(20), }}>
