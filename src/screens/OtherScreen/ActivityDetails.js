    ...
    return (
        <>
            <HeaderView HeaderSmall={true} StackScreen={true}
                title={route?.params?.item?.activityName} onPress={() => goBack()} isBack={true} containerStyle={{ paddingHorizontal: pixelSizeHorizontal(0) }}
                titleColor={white}
                ...
                <View style={{ margin: 20, }}>
                    <View
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", }}>
                            ...
                            <Text style={{ fontFamily: SEMIBOLD, fontSize: FontSize.FS_16, color: black, paddingHorizontal: 8 }}>{"Indian Premier League"}</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10, }}>
                            <Icon name={"map-marker-radius-outline"} size={30} color={secondary} />
                            <View>
                                <Text style={{ fontFamily: REGULAR, fontSize: FontSize.FS_16, color: black, marginHorizontal: 10 }}>Ahemedabad cricket ground</Text>
                                <Text style={{ fontFamily: REGULAR, fontSize: FontSize.FS_16, color: black, marginHorizontal: 10 }}>Thaltej</Text>
                            </View>
                        </View>

                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10, }}>
                            <Icon name={"calendar-range"} size={30} color={secondary} />
                            <Text style={{ fontFamily: REGULAR, fontSize: FontSize.FS_15, color: black, marginHorizontal: 10 }}>12/11/2023</Text>
                        </View>

                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10, }}>
                            <Icon name={"clock-time-five-outline"} size={30} color={secondary} />
                            <Text style={{ fontFamily: REGULAR, fontSize: FontSize.FS_15, color: black, marginHorizontal: 10 }}>10:45 PM</Text>
                        </View>

                            <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 10, }}>
                                <Icon name={"currency-usd"} size={30} color={secondary} />
                                <Text style={{ fontFamily: SEMIBOLD, fontSize: FontSize.FS_16, color: black, marginHorizontal: 10, }}>Joining type : <Text style={{ fontFamily: REGULAR, fontSize: FontSize.FS_15, color: black, marginHorizontal: 10 }}>Free</Text></Text>
                            </View>
